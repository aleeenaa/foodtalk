...
const startJourneyAction = "journey.start",
	...
	availableFoodSpotsPrompts = ["These places sell %s: %s."],
	availableCuisineFoodSpotsPrompts = ["Sure. These places sell %s cuisine: %s."],
...
app.post('/', function(request, response) {
	...
	function browseByFood(assistant) {
		...
		if (matchedSpots.length > 1) {
			matchedSpots = concatList(matchedSpots)
			console.log(matchedSpots)
		}
		ask(assistant, printf(availableFoodSpotsPrompts + " " + whichRestaurantPrompt, query.food, matchedSpots))
	}
	...
	function browseByCuisine(assistant) {
		...
		ask(assistant, printf(availableCuisineFoodSpotsPrompts + " " + whichRestaurantPrompt, cuisine, matchedSpots))
	}
